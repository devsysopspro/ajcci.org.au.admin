...
<p>
    Hi {{ $user->name }},<br><br>
    Welcome to the Australian Jordanian Chamber of Commerce and Industry organisation. Your membership application has been approved.
</p>

<p>
    Here are your membership details: <br>
    Name: {{ $user->name }} <br>
    Email: {{ $user->email }} <br>
    Membership Level: {{ $user->renderMembershipShort() }}
</p>

<p>
    You can login to your account using your email address and the password you provided.
</p>

<p>
    Congratulations, you just joined an exclusive network of professionals in their industry.
</p>


<p>
    The Australian Jordanian Chamber of Commerce & Industry (AJCCI) was founded in 2018. the Australian Jordanian Chamber is an independent not-for-profit organisation. AJCCI aims to build business connections and assist trade between Australia and Jordan.
</p>

<p>
    As a new member, here are some of the benefits you receive: <br>
    - Attendance at our frequent networking session <br>
    - Exclusive access to our online library of resources <br>
    - And more!
</p>


<p>
    We would love to have you at our next networking event! Please check our website for upcoming events. Look out for an invitation.”
</p>

<p>
    Don't hesitate to contact us on any enquiry.
</p>
